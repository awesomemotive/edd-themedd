...
<div id="affwp-affiliate-dashboard">
	...
	<?php if ( 'active' == affwp_get_affiliate_status( affwp_get_affiliate_id() ) ) : ?>
		...
		<div class="account-nav">
			<ul id="affwp-affiliate-dashboard-tabs" class="d-flex d-lg-block flex-wrap">
			...
			if ( $tabs ) {
				foreach ( $tabs as $tab_slug => $tab_title ) : ?>
					...
					<li class="mr-3 mr-lg-0 mb-2 affwp-affiliate-dashboard-tab<?php echo $active_tab == $tab_slug ? ' active' : ''; ?>">
