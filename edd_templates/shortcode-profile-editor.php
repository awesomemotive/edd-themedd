 ...
 * This template can be removed once https://github.com/easydigitaldownloads/easy-digital-downloads/issues/3904 is completed
 */
global $current_user;
...
if ( is_user_logged_in() ):
	...
	<form id="edd_profile_editor_form" class="edd_form" action="<?php echo edd_get_current_page_url(); ?>" method="post">
		<fieldset>
			...
			<legend><?php _e( 'Change your Name', 'easy-digital-downloads' ); ?></legend>
		...
		<fieldset>
			<legend><?php _e( 'Change your Billing Address', 'easy-digital-downloads' ); ?></legend>
		...
		<fieldset>
			<legend><?php _e( 'Change your Password', 'easy-digital-downloads' ); ?></legend>
