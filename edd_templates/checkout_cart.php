...
<table id="edd_checkout_cart" <?php if ( ! edd_is_ajax_disabled() ) { echo 'class="ajaxed"'; } ?>>
	<thead>
		<tr class="edd_cart_header_row">
			...
			<th class="edd_cart_actions text-right"><?php _e( 'Actions', 'easy-digital-downloads' ); ?></th>
	...
	<tfoot>
		...
		<?php if( edd_use_taxes() && ! edd_prices_include_tax() ) : ?>
			<tr class="edd_cart_footer_row edd_cart_subtotal_row"<?php if ( ! edd_is_cart_taxed() ) echo ' style="display:none;"'; ?>>
				...
				<th colspan="<?php echo edd_checkout_cart_columns(); ?>" class="edd_cart_subtotal text-right">
		...
		<tr class="edd_cart_footer_row edd_cart_discount_row" <?php if( ! edd_cart_has_discounts() )  echo ' style="display:none;"'; ?>>
			...
			<th colspan="<?php echo edd_checkout_cart_columns(); ?>" class="edd_cart_discount text-right">
		...
		<?php if( edd_use_taxes() ) : ?>
			<tr class="edd_cart_footer_row edd_cart_tax_row"<?php if( ! edd_is_cart_taxed() ) echo ' style="display:none;"'; ?>>
				...
				<th colspan="<?php echo edd_checkout_cart_columns(); ?>" class="edd_cart_tax text-right">
		...
		<tr class="edd_cart_footer_row">
			...
			<th colspan="<?php echo edd_checkout_cart_columns(); ?>" class="edd_cart_total text-right"><?php _e( 'Total', 'easy-digital-downloads' ); ?>: <span class="edd_cart_amount" data-subtotal="<?php echo edd_get_cart_subtotal(); ?>" data-total="<?php echo edd_get_cart_total(); ?>"><?php edd_cart_total(); ?></span></th>
