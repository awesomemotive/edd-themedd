...
if ( themedd_is_edd_active() ) {
	...
	require_once( trailingslashit( THEMEDD_INCLUDES_DIR ) . 'compatibility/edd/checkout-template.php' );
	require_once( trailingslashit( THEMEDD_INCLUDES_DIR ) . 'compatibility/edd/template-functions.php' );
